...
FLUENT_COMMENT_FORM_CLASS = 'fluent_comments.CompactLabelsCommentForm'
...
FLW_SANDBOX = True if env("FLW_SANDBOX") == 'True' else False
FLW_PRODUCT = True if env("FLW_PRODUCT") == 'True' else False
